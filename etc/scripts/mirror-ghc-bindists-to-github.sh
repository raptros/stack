...
#@@@ UPDATE UPSTREAM
#@@@ AT SOME POINT CAN REMOVE NOPIES
#@@@ KEEP IN SAME ORDER AS STACK-SETUP-2.YAML
mirror i386-deb8-linux xz xz linux32 linux32-nopie
mirror x86_64-deb8-linux xz xz linux64 linux64-nopie
mirror x86_64-fedora27-linux xz xz linux64-tinfo6 linux64-tinfo6-nopie linux64-ncurses6 linux64-ncurses6-nopie #@@@ TEST
